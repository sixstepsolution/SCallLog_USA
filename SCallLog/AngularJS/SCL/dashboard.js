app.controller('DashBoardCtrl', function ($scope, $http, $localStorage) {
    ...
    $http.get("../SCall/getComplaintsCount").then(
        function (response) {
    ...
    $scope.showCategory = function (department, DeptID, color) {
       // alert(color)
        ...
        $http.get("../SCall/getComplaintsCategorywiseCount?Department=" + department + "&DeptID=" + DeptID).then(
            function (response) {
                if (response.data.success == true) {
                    console.log(response.data);
    ...
    $scope.showSubCategory = function (Category, CatID) {
        ...
        $http.get("../SCall/getComplaintsSubCategorywiseCount?Category=" + Category + "&CatID=" + CatID).then(
            function (response) {
                if (response.data.success == true) {
                    console.log(response.data);
    ...
    $scope.showComplaintsTableDepartmentWise = function (Department, Search) {
        //alert(Search)
        ...
        $http.get("../SCall/getAllDepartmentComplaints?pageIndex=" + $scope.pageIndex
